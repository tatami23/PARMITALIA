(function(){
  var VERSION = "pms_v217_force_visible_sidebar_menu";
  ...
  var guardTimer = setInterval(function(){
    guardAttempts += 1;
    var host = document.getElementById("pms152-menu");
    if (!host || !host.querySelector("[data-pms152-page]")) drawMenu();
    if (guardAttempts >= 45) clearInterval(guardTimer);
  }, 1000);

  window.PMS_V217_FORCE_VISIBLE_SIDEBAR_MENU = {
    version: VERSION,
    refresh: drawMenu
  };
})();
